...
- Include all the jars in the Jars folder
- combinedDF.csv file is generated by executing the Task1_Project.py, updated the path of combinedDF.csv in GenerateIndex.java file to the location it was created, and execute
